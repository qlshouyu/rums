...
import com.qlshouyu.rums.modules.system.service.MonitorService;
import com.qlshouyu.rums.utils.RUMSConstant;
...
public class MonitorServiceImpl implements MonitorService {
    ...
    private Map<String,Object> getDiskInfo(OperatingSystem os) {
        ...
        for (OSFileStore fs : fsArray){
            ...
            if(osName.toLowerCase().startsWith(RUMSConstant.WIN)) {
